                    ...
                    {
                        {
                            ...
                            func.BuildAndFillRectangleArea(rectangle.height, rectangle.width, -1, -1, -1, -1);
                            Console.ReadKey();
                            Console.Clear();
                            ...
                            do
                            {
                                ...
                                if (a == 'y' | a == 'Y')
                                {
                                    ...
                                    func.BuildAndFillRectangleArea(rectangle.height, rectangle.width, xStartCoord, yStartCoord, xEndCoord, yEndCoord);
